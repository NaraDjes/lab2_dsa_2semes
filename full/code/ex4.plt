...
plot "data_ex4.txt" using 1:2 title "Average case bstree_min" with linespoints ls 1, \
"data_ex4.txt" using 1:3 title "Worst case bstree_min" with linespoints ls 2